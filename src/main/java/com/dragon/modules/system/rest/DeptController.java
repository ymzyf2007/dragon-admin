...
public class DeptController {
    ...
    @ApiOperation("新增部门")
    @PostMapping
    @PreAuthorize("@dragon.check('dept:add')")
    ...
    @ApiOperation("修改部门")
    @PutMapping
    @PreAuthorize("@dragon.check('dept:edit')")
    ...
    @Log("根据部门ID列表删除部门")
    @ApiOperation("根据部门ID列表删除部门")
    @DeleteMapping
    @PreAuthorize("@dragon.check('dept:del')")
